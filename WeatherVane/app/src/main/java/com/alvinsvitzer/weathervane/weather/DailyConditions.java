 ...
 */
public class DailyConditions implements Parcelable {
    ...
    private DailyConditions(Parcel in){
        mTime = in.readLong();
    ...
    public static final Creator<DailyConditions> CREATOR = new Creator<DailyConditions>() {
        ...
        public DailyConditions createFromParcel(Parcel source) {
            return new DailyConditions(source);
        }

        @Override
        public DailyConditions[] newArray(int size) {
            return new DailyConditions[size];
        }
    };
